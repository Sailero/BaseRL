...
class StochasticActor(ChkptModule):
    def __init__(self, args, network_type):
        super(StochasticActor, self).__init__(args, network_type)
        # 获取 args 中的维度信息
...
class StochasticActor2d(ChkptModule):
    def __init__(self, args, network_type):
        super(StochasticActor2d, self).__init__(args, network_type)
...
class StochasticCritic2d(ChkptModule):
    def __init__(self, args, network_type):
        super(StochasticCritic2d, self).__init__(args, network_type)
